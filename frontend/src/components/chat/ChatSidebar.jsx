  ...
  return (
    ...
    >
      ...
      <div className="chat-convo-item__info">
        <div className="chat-convo-item__name">{chat.title}</div>
        <div className="chat-convo-item__preview">Last activity</div>
      </div>
...
const ChatSidebar = ({ mobileOpen }) => {
  ...
  const handleLogout = async () => {
    try {
      await axios.post(
        "https://luna-8gpi.onrender.com/api/auth/logout",
        {},
      ...
      <aside className={`chat-sidebar ${mobileOpen ? "open" : ""}`}>
        ...
        <div className="chat-sidebar__header">
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button className="chat-sidebar__logout-btn" onClick={handleLogout}>
              LOGOUT
            </button>
          </div>
        </div>
        ...
        <div className="chat-sidebar__profile">
          ...
          <div>
            ...
            <div className="chat-sidebar__profile-status">● Online</div>
          </div>
        </div>
      </aside>
